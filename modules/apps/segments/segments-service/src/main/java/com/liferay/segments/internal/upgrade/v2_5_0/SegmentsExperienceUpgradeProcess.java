...
public class SegmentsExperienceUpgradeProcess extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		if (!hasColumn("SegmentsExperience", "layoutSetBranchId")) {
			alter(
				SegmentsExperienceUpgradeProcess.class,
				new AlterTableAddColumn("layoutSetBranchId", "LONG"));

			runSQL("update SegmentsExperience set layoutSetBranchId = 0");
		}
	}
