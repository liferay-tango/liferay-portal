...
public class ContentDashboardAdminManagementToolbarDisplayContextTest {
	...
	public void testGetFilterLabelItemsWithContentDashboardItemFilterProvider() {
		...
		Assert.assertEquals("contentDashboardItemFilterParameterLabel: value1", labelItem.get("label"));

		labelItem = labelItems.get(1);

		Assert.assertEquals("contentDashboardItemFilterParameterLabel: value2", labelItem.get("label"));
	}
