...
public class SegmentsExperienceModelListenerTest {
	...
	public void testOnAfterUpdate() throws Exception {
		...
		_segmentsExperimentRelService.addSegmentsExperimentRel(
			...
			segmentsExperience1.getSegmentsExperienceId(), _serviceContext);
		...
		try (CompanyConfigurationTemporarySwapper
			...
			String name = "Variant 1 modified";

			segmentsExperience1.setNameMap(
			...
			Assert.assertEquals(
				name, segmentsExperience2.getName(LocaleUtil.getSiteDefault()));
		}
		finally {
			ReflectionTestUtil.setFieldValue(
	...
	@Inject(
		filter = "component.name=com.liferay.segments.asah.connector.internal.model.listener.SegmentsExperienceModelListener"
	)
